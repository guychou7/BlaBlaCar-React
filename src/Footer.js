...
function Footer() {
    return (
        <footer className="row footer">
            <div className="col-lg-12 footer-middle bg-dark-blue py-5">
                    ...
                    <div className="container">
                        <div className="row mt-3">
                            <div className="col-lg-6">
                                ...
                                <div className="mt-3">
                                    <p className="about_blablacar">Premier réseau de covoiturage au monde, nous mettons en relation passagers et conducteurs prêts à partager leur trajet sans changement.</p>
                                </div>
                                <ul className="list-inline fot_social">
                                    <li className="list-inline-item"><a href="https://facebook.com/blablacar.fr" className="social-icon text-muted"><FaFacebookF/></a></li>
                                    <li className="list-inline-item"><a href="https://twitter.com/BlaBlaCar_FR" className="social-icon text-muted"><FaTwitter/></a></li>
                                    <li className="list-inline-item"><a href="https://youtube.com//c/BlaBlaCarFR" className="social-icon text-muted"><FaYoutube/></a></li>
                                    <li className="list-inline-item"><a href="https://www.instagram.com/blablacarfr/" className="social-icon text-muted"><FaInstagram/></a></li>
                                </ul>
                            </div>
                            <div className="col-lg-2">
                                <h6 className="mt-3 footer_menu_title">Nos services</h6>
                                <ul className="list-unstyled footer_menu_list mt-3">
                                    <li><Link to="/">Comment ça marche</Link></li>
                                    <li><Link to="/">Assurance et covoiturage</Link></li>
                                    <li><Link to="/">Trajets quotidiens BlaBlaLines</Link></li>
                                    <li><Link to="/">Voyagez en bus</Link></li>
                                </ul>
                            </div>
                            <div className="col-lg-2">
                                <h6 className="mt-3 footer_menu_title">A propos</h6>
                                <ul className="list-unstyled footer_menu_list mt-3">
                                    <li><Link to="/">Qui sommes-nous ?</Link></li>
                                    <li><Link to="/">Foire aux questions</Link></li>
                                    <li><Link to="/">Contact</Link></li>
                                    <li><Link to="/">Transparence des plateformes</Link></li>
                                </ul>
                            </div>
                            <div className="col-lg-2">
                                <h6 className="mt-3 footer_menu_title">Liens utiles</h6>
                                <ul className="list-unstyled footer_menu_list mt-3">
                                    <li><Link to="/">Informations légales</Link></li>
                                    <li><Link to="/">Politique de confidentialite</Link></li>
                                    <li><Link to="/">Presse</Link></li>
                                    <li><Link to="/">Nous recrutons</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div className="col-lg-12 footer-bottom ">
                <div className="container py-4">
                    <div className="container">
                        <div className="row footer_utils">
                            <div className="col-lg-4">
                                    <p className="copy-rights mb-0">BlaBlaCar, 2020&copy;. <a href="https://fr.reactjs.org/" target="_blank" rel="noopener noreferrer">React</a> vs <a href="http://broucharles.com/" target="_blank" rel="noopener noreferrer">BAGC</a></p>
                            </div>
                            <div className="col-lg-4 offset-md-4 languageselectore">
                                <MdTranslate/> Langues&nbsp;
                                <select>
