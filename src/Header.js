...
function Nav() {
    return (
        <nav className="navbar navbar-expand-md fixed-top">
                ...
                <div className="collapse navbar-collapse">
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item">
                            <Link to="/" className="nav-link"><SecurityIcon/> BlaBlaSure </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/search-car-sharing" className="nav-link"><SearchIcon/> Rechercher </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/" className="nav-link"><PlusCircleIcon/> Proposer un trajet </Link>
                        </li>
                        <li className="nav-item">
            ...
            <div className="container-fluid navmobile">
                <div className="userconnect">
                        <li>
                            <Link to="/" className="nav-link"><UserIcon/></Link>
                        </li>
                </div>
                <div className="logo text-center">
                    <li>
                        <Link to="/" className="nav-link"><LogoSVGMobile/></Link>
                    </li>
                </div>
                <div className="useractions">
                    <li>
                        <Link to="/search-car-sharing" className="nav-link"><SearchIcon/></Link>
                    </li>
                    <li>
                        <Link to="/" className="nav-link"><PlusCircleIcon/></Link>
                    </li>
                </div>
            </div>
        </nav>
